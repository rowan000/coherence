 ...
 */
public class PropertyExternSerializer implements ObjectSerializer<Property> {

    private static PropertyExternSerializer INSTANCE = new PropertyExternSerializer();

    private PropertyExternSerializer(){}


    public static PropertyExternSerializer getInstance() {
        return INSTANCE;
    }
